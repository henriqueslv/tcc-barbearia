...
appointmentsRouter.use(ensureAutenticated_1.default);
// Rota GET
appointmentsRouter.get('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                appointmentRepository = (0, typeorm_1.getCustomRepository)(AppointmentsRepository_1.default);
...
appointmentsRouter.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, provider_id, date, parsedDate, createAppointment, appointment, err_1;
