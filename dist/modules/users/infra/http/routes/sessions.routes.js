...
var AutenticateUserService_1 = __importDefault(require("../../../services/AutenticateUserService"));
...
sessionsRouter.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, autenticateUser, _b, user, token, err_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 2, , 3]);
                _a = request.body, email = _a.email, password = _a.password;
                autenticateUser = new AutenticateUserService_1.default();
                return [4 /*yield*/, autenticateUser.execute({
                        email: email,
                        password: password
                    })];
            case 1:
