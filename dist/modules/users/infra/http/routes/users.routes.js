...
var ensureAutenticated_1 = __importDefault(require("../../../../../shared/infra/http/middlewares/ensureAutenticated"));
...
usersRouter.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name_1, email, password, createUser, user, err_1;
...
usersRouter.patch('/avatar', ensureAutenticated_1.default, upload.single('avatar'), function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var updateUserAvatar, user, err_2;
